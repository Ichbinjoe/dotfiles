...
# lock i3
bindsym $mod+shift+x exec ~/.config/i3/i3lock-multimonitor -e "/home/joe/wallpaper.png" && echo mem > /sys/power/state
...
exec_always --no-startup-id feh --bg-scale /home/joe/wallpaper.png
